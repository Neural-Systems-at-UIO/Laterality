"""
This code merges all the region pixels for a given rat in a table
...
def gather_data_from_folder(folder_path):
    """
    Gathers region pixels data from all CSV files in the RefAtlasRegions folder and returns a DataFrame 
    ...
    for file in files:
        ...
        try:
            ...
            df_slice = df_slice[['Region pixels']].rename(columns={'Region pixels': slice_num}).transpose()
...
def main():
    ...
    output_filename = f"{rat_number}{suffix}_regions.xlsx"
